...
export const getMOrders = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/manager/orders'
...
export const getChefs = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/chefs'
...
export const postApprovedOrder = (chefId, customerId) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/order/add'
...
export const getAllWaiters = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/waiters'
...
export const assignWaiterToTable = (waiterId, tableNo) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:8081/waiter/assign/${waiterId}/${tableNo}`
