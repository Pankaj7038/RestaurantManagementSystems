...
export const signup = (name, username, email, password, role) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/register'
    axios
...
export const getstock = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/stocks'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getProfile = () => {
  return (dispatch) => {
    ...
    const url = `http://localhost:8081/admin/get/${adminId}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getSupplier = (id) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:8081/supplier/getingredinet/${id}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const updatestock = (id, name, qty) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/updatestock'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const getmenu = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/menu/getall'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getFeedback = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/admin/feedback'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getingredinet = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/ingredients/list'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const addMenuItem = (menuName, category, price, ingredients) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:8081/menu/add'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const updateProfile = (name, username, email, password, role) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:8081/admin/update/${id}`
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
